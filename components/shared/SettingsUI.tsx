  ...
  return (
    <div className="settings-panel blur custom-scroll">
      ...
      <div className="settings-group">
        ...
        <div data-tippy-content="Removes the page sidebar on the following sites when the Dictionary sidebar is open to improve usability. May cause unexpected results.<br>• BBC.com<br>• wikipedia.org<br>• mahamegha.lk<br>• mahamevnawa.lk<br>• lankadeepa.lk<br>• hirunews.lk<br>• news.lk<br>• adaderana.lk<br>• reddit.com" className="settings-control"
          data-tippy-allowhtml="true">
          <label className="checkbox-container">
            <input
              type="checkbox"
